# Bonfire
  ...
  GitHub says C is the primary language but that's only because miniaudio is a staggering 95,000 lines of C

## Build

  For build instructions, visit [bonfireengine.com](https://bonfireengine.com/download)
